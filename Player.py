class Player:
    ...
    def get_player_current_tile_location(self, arr_world_map_back_end):
        ...
        print(f"You're currently on {player_current_tile_location.str_tile_name} Island in the {player_current_tile_location.str_tile_quadrant} quadrant of the map")
